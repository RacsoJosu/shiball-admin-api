...
router.post(
  ...
  authController.postResgisterUser.bind(authController)
);
router.post(
  '/login',
  validateData(loginUserSchema),
  authController.postLogiUser.bind(authController)
);
router.post(
  '/logout',
  authGuard,
  authController.postLogoutUser.bind(authController)
);
router.get(
  '/me',
  authGuard,
  authController.getUserAuthInfo.bind(authController)
);
